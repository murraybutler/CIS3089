                                        ...
                                        implements BinarySearchTreeADT<T>
{
    ...
    public T removeMax() throws EmptyCollectionException 
    {
      ...
      if (isEmpty()) {
        ...
        if (root.right == null) {
          ...
          BinaryTreeNode<T> par = root;
          BinaryTreeNode<T> cur = root.right;
    ...
    public T find(T targetElement) throws ElementNotFoundException 
    {
      ...
      BinaryTreeNode<T> tmp = cur;
      if (!(cur.element.equals(targetElement)) && (cur.left != null) && 
          ((Comparable)cur.element).compareTo(targetElement) > 0) {
        cur = findNode(targetElement, cur.left);
      } else if (!(cur.element.equals(targetElement)) && (cur.right != null)) {
        cur = findNode(targetElement, cur.right);
      }

      if (!(cur.element.equals(targetElement))) {
        throw new ElementNotFoundException("LinkedBinarySearchTree");
      }
    ...
    {
       BinaryTreeNode<T> cur = next;
       if (!(next.element.equals(targetElement)) && (next.getLeft() != null) &&
           ((Comparable)cur.element).compareTo(targetElement) > 0) {
         next = findNode(targetElement, next.left);
       } else if (!(next.element.equals(targetElement)) && (next.getRight() != null)) {
    ...
    /**
     * Public interface for toString
     * @return String Tree as string
     */
    ...
    /**
     * A recursive method to return the "tree" in a string of elements
     * @return String Tree as string
     * @param root Node to start from
     */
    private String toString(BinaryTreeNode<T> root)
    {
      String out = "";
      if (root == null) {
        return out;
      }
      out += toString(root.left);
      out += toString(root.right);
      out += ",";
      out += root.element;
      return out;
    }
